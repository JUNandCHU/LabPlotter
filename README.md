...
- Lab DLS raw Radius/Meas CSVs, two plots with a right-hand particle list, separate persistent library, draggable mean-radius annotations, representative/all-measurement overlays and intensity-weighted size/%PD tables
...
The current development release is **0.9.0**. Version 0.5.1 remains the first GitHub baseline. See [README_KO.md](README_KO.md) for the detailed Korean guide.
